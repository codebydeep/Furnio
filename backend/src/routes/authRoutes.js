...
import { register, login, me, getAllUsers, getUserById, createUser, updateUser, changeRole, deleteUser } from '../controllers/authController.js'
import { authenticate } from '../middleware/authenticate.js'
import { authorize } from '../middleware/authorize.js'
import { CAN_MANAGE_USERS } from '../config/roles.js'
import { registerSchema, loginSchema, createUserSchema, changeRoleSchema, validate } from '../validators/authValidator.js'
...
router.post  ('/users',          authenticate, authorize(...CAN_MANAGE_USERS), validate(createUserSchema), createUser)
